 ...
 * 如果您使用此代码，请保留此说明。
 ******************************************************************************
 * 文件名称: PolysyllabicSet.cs
 * 文件说明: 控件基类
 * 当前版本: V1.0.0
 * 创建日期: 2021-10-13 17:20:56
 *
******************************************************************************/
using System;
...
namespace Chan.Pinyin.Comparison
{
    ...
    /// 多音词集合
    /// </summary>
    internal class PolysyllabicSet
    {
        /// <summary>
        /// 多音词集合
        /// </summary>
        internal static Dictionary<string, string> Dictionary
        {
            get
            {
                return polysyDictionary;
            }
        }
        private readonly static Dictionary<string, string> polysyDictionary = new Dictionary<string, string> {
        {"阿訇", "ā,hōng"},
        {"阿罗汉", "ā,luó,hàn"},
        {"阿木林", "ā,mù,lín"},
        {"阿姨", "ā,yí"},
