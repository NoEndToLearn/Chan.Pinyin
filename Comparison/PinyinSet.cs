...
namespace Chan.Pinyin.Comparison
{
    ...
    public static class PinyinSet
    {
        ...
        public static Dictionary<string, string> Dictionary
        {
            get
            {
                return pinyinnDictionary;
            }
        }
        private readonly static Dictionary<string, string> pinyinnDictionary = new Dictionary<string, string>
        {
            #region
        {"〇", "líng"},
        {"一", "yī"},
